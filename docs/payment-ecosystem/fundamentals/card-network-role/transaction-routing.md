...
- **[Transaction Lifecycle](/payment-ecosystem/fundamentals/transaction-lifecycle/overview)** - Authorization through settlement
- **[Pre-Authorizations](/payment-ecosystem/fundamentals/transaction-lifecycle/pre-authorizations)** - Detailed auth process

**Technical Standards:**
- **[Network Rules](/payment-ecosystem/fundamentals/card-network-role/network-rules)** - How networks govern routing
- **ISO/IEC 7812** - BIN/IIN standard specification

---

*Continue learning: [Network Rules and Compliance](/payment-ecosystem/fundamentals/card-network-role/network-rules)*
