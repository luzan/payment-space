...
- **[Transaction Routing](/payment-ecosystem/fundamentals/card-network-role/transaction-routing)** - How networks route transactions

**Risk Management:**
- **[Chargebacks and Disputes](/payment-ecosystem/fundamentals/transaction-lifecycle/chargebacks)** - Dispute process details
...
- **[PayFac Compliance](/payment-ecosystem/fundamentals/four-party-model/payfac)** - PayFac-specific compliance
...
*Continue learning: [Network Fees and Assessments](/payment-ecosystem/fundamentals/card-network-role/network-fees)*
