...
- [The Four-Party Model](/payment-ecosystem/fundamentals/four-party-model) - Participants and interchange economics
- [Card Network Role](/payment-ecosystem/fundamentals/card-network-role) - Network rules, routing, and assessment fees
- [Debit Networks & Routing](/payment-ecosystem/fundamentals/debit-networks-routing) - PIN vs signature debit
- [Payment Processors](/payment-ecosystem/industry-players/payment-processors) - Processing infrastructure
- [Payment Gateways](/payment-ecosystem/industry-players/payment-gateways/overview) - Tokenization and security
