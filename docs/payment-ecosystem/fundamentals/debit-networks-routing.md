---
title: "Debit Networks & Routing"
description: "Understanding PIN vs signature debit, Durbin Amendment, and least-cost routing strategies"
sidebar_position: 4
sidebar_label: "Debit Networks & Routing"
keywords:
  - PIN debit
  - signature debit
  - Durbin Amendment
...
Debit card routing is one of the most complex and economically significant aspects of payment processing. Unlike credit cards that route through a single [card network](/payment-ecosystem/fundamentals/card-network-role) (Visa or Mastercard), debit transactions can route through multiple networks. This creates opportunities for cost optimization.
...
The regulatory landscape for debit interchange is actively evolving. There have been ongoing court challenges and proposed legislative changes. Always verify current regulatory status when making business decisions.
:::
...
| Topic | Description |
|-------|-------------|
| [The Four-Party Model](/payment-ecosystem/fundamentals/four-party-model) | Understanding interchange and fee structures |
| [Card Network Role](/payment-ecosystem/fundamentals/card-network-role) | BIN routing and network rules |
| [Transaction Lifecycle](/payment-ecosystem/fundamentals/transaction-lifecycle/overview) | Authorization, settlement, and chargebacks |
| [Payment Processors](/payment-ecosystem/industry-players/payment-processors) | Processor-owned networks (Fiserv STAR, FIS NYCE) |
| [Payment Gateways](/payment-ecosystem/industry-players/payment-gateways/overview) | Tokenization and CNP transaction handling |
| [Acquiring Banks](/payment-ecosystem/industry-players/acquiring-banks/overview) | Merchant settlement and funding |
| [ISOs](/payment-ecosystem/industry-players/isos) | Merchant sales and routing optimization |
