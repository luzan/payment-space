...
See Four-Party Model <!-- (/payment-ecosystem/core-concepts/four-party-model not yet migrated) --> for more on the foundational payment structure and [Payment Processors](/payment-ecosystem/industry-players/payment-processors) for processor roles.
...
See Four-Party Model <!-- (/payment-ecosystem/core-concepts/four-party-model not yet migrated) --> for the foundational payment structure that ISOs operate within.
...
*Previous Topic: [Acquiring Banks](/payment-ecosystem/industry-players/acquiring-banks/overview)*

*Next Topic: [ISVs (Independent Software Vendors)](/payment-ecosystem/industry-players/isvs)*
...
| Transaction Lifecycle <!-- (/payment-ecosystem/core-concepts/transaction-lifecycle not yet migrated) --> | Authorization and settlement that ISOs don't control |
| [Payment Processors](/payment-ecosystem/industry-players/payment-processors) | Processors that ISOs partner with |
| [Payment Gateways](/payment-ecosystem/industry-players/payment-gateways/overview) | Gateway solutions ISOs resell |
| [Acquiring Banks](/payment-ecosystem/industry-players/acquiring-banks/overview) | Sponsor banks for ISO registration |
| [ISVs](/payment-ecosystem/industry-players/isvs) | PayFac model that competes with ISOs |
