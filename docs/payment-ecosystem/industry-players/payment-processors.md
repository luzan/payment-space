...
Payment processors are the technical backbone of the card payment ecosystem. They provide the infrastructure that routes transactions between merchants, [card networks](/payment-ecosystem/fundamentals/card-network-role), and banks. Understanding processors is essential for anyone building a PayFac platform.
...
| [Card Network Role](/payment-ecosystem/fundamentals/card-network-role) | BIN routing and network certifications |
...
| [Debit Networks & Routing](/payment-ecosystem/fundamentals/debit-networks-routing) | Processor-owned networks (STAR, NYCE) |
