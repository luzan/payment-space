...
**Key Distinction:** Acquiring banks are on the "merchant side" of the transaction, while issuing banks are on the "cardholder side." This distinction is fundamental to the Four-Party Model <!-- (/payment-ecosystem/core-concepts/four-party-model not yet migrated) -->.
...
For more on processors, see [Payment Processors](/payment-ecosystem/industry-players/payment-processors).
...
• "[ISO model](/payment-ecosystem/industry-players/isos)" emerges: Non-bank sales agents acquire merchants
...
For detailed transaction lifecycle, see [Transaction Lifecycle Basics<!-- (/payment-ecosystem/core-concepts/transaction-lifecycle not yet migrated) -->.
