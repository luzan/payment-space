---
title: "Major Acquiring Banks"
description: "Chase Paymentech, Elavon, Bank of America, Wells Fargo comparison and market dynamics"
sidebar_position: 2
sidebar_label: "Major Acquirers"
keywords:
  - Chase Paymentech
  - Elavon
...
See Four-Party Model <!-- (/payment-ecosystem/core-concepts/four-party-model not yet migrated) --> for detailed fee breakdown diagrams.
...
*Previous Topic: [Payment Gateways](/payment-ecosystem/industry-players/payment-gateways/overview)*

*Next Topic: [ISOs (Independent Sales Organizations)](/payment-ecosystem/industry-players/isos)*
...
| Transaction Lifecycle <!-- (/payment-ecosystem/core-concepts/transaction-lifecycle not yet migrated) --> | Settlement, funding, and chargebacks |
| Debit Networks [Debit Networks & Routing Routing<!-- (/payment-ecosystem/core-concepts/debit-routing not yet migrated) --> | Durbin Amendment and debit interchange |
| [Payment Processors](/payment-ecosystem/industry-players/payment-processors) | Processor vs acquirer distinction |
| [Payment Gateways](/payment-ecosystem/industry-players/payment-gateways/overview) | Gateway integration with acquirers |
| [ISOs](/payment-ecosystem/industry-players/isos) | ISO-acquirer relationships |
| [ISVs](/payment-ecosystem/industry-players/isvs) | PayFac model and sponsor bank requirements |
