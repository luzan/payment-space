...
Debit card routing is one of the most complex and economically significant aspects of payment processing. Unlike credit cards that route through a single [card network](/ecosystem/fundamentals/card-network-role) (Visa or Mastercard), debit transactions can route through multiple networks. This creates opportunities for cost optimization.
...
| Topic | Description |
|-------|-------------|
| [The Four-Party Model](/ecosystem/fundamentals/four-party-model) | Understanding interchange and fee structures |
| [Card Network Role](/ecosystem/fundamentals/card-network-role) | BIN routing and network rules |
| [Transaction Lifecycle](/ecosystem/fundamentals/transaction-lifecycle/overview) | Authorization, settlement, and chargebacks |
| [Payment Processors](/ecosystem/industry-players/payment-processors) | Processor-owned networks (Fiserv STAR, FIS NYCE) |
| [Payment Gateways](/ecosystem/industry-players/payment-gateways/overview) | Tokenization and CNP transaction handling |
| [Acquiring Banks](/ecosystem/industry-players/acquiring-banks/overview) | Merchant settlement and funding |
| [ISOs](/ecosystem/industry-players/isos) | Merchant sales and routing optimization |
| [ISVs](/ecosystem/industry-players/isvs) | PayFac model and embedded payments |
