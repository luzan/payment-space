...
- [Four-Party Model](/ecosystem/fundamentals/four-party-model) - Understand the participants
- [Card Network Role](/ecosystem/fundamentals/card-network-role) - Network rules and fees
