...
- **[Network Rules](/ecosystem/fundamentals/card-network-role/network-rules)** - Compliance and governance

**Fee Analysis:**
- **[Fee Breakdown](/ecosystem/fundamentals/four-party-model/fee-breakdown)** - Complete fee structure including interchange
- **[Interchange Optimization](/ecosystem/fundamentals/four-party-model/optimization)** - Reducing total processing costs

**Pricing Models:**
- **[PayFac Economics](/ecosystem/fundamentals/four-party-model/payfac)** - How PayFacs price and profit
...
*Continue learning: [Card-Present vs Card-Not-Present](/ecosystem/fundamentals/card-network-role/card-present-vs-cnp)*
