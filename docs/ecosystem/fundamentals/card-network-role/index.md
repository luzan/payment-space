...
**[Open-Loop vs Closed-Loop Networks](/ecosystem/fundamentals/card-network-role/open-vs-closed-loop)**
...
**[Transaction Routing](/ecosystem/fundamentals/card-network-role/transaction-routing)**
...
**[Network Rules and Compliance](/ecosystem/fundamentals/card-network-role/network-rules)**
...
**[Network Fees and Assessments](/ecosystem/fundamentals/card-network-role/network-fees)**
...
**[Card-Present vs Card-Not-Present](/ecosystem/fundamentals/card-network-role/card-present-vs-cnp)**
...
**[Self-Assessment Quiz](/ecosystem/fundamentals/card-network-role/quiz)**
...
| Topic | Description |
|-------|-------------|
| [The Four-Party Model](/ecosystem/fundamentals/four-party-model) | Core participants (issuer, acquirer, network) explained |
| [Transaction Lifecycle](/ecosystem/fundamentals/transaction-lifecycle/overview) | How authorization, capture, and settlement actually work |
| [Debit Networks & Routing](/ecosystem/fundamentals/debit-networks-routing) | PIN networks, Durbin Amendment, and least-cost routing |

---

*Continue learning: Choose a topic above or test your knowledge with the [quiz](/ecosystem/fundamentals/card-network-role/quiz)*
