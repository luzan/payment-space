...
**If you scored well:**
- Move on to [Transaction Lifecycle](/ecosystem/fundamentals/transaction-lifecycle/overview)
- Explore [Debit Networks & Routing](/ecosystem/fundamentals/debit-networks-routing)
- Deep dive into [PayFac Model](/ecosystem/fundamentals/four-party-model/payfac)

**If you need review:**
- Revisit [Card Network Role Overview](/ecosystem/fundamentals/card-network-role/)
- Study [Open-Loop vs Closed-Loop](/ecosystem/fundamentals/card-network-role/open-vs-closed-loop) for network models
- Review [Transaction Routing](/ecosystem/fundamentals/card-network-role/transaction-routing) for BIN routing
- Read [Network Rules](/ecosystem/fundamentals/card-network-role/network-rules) for compliance
- Check [Network Fees](/ecosystem/fundamentals/card-network-role/network-fees) for fee structure
- Understand [Card-Present vs CNP](/ecosystem/fundamentals/card-network-role/card-present-vs-cnp) for risk differences
...
**Card Network Series:**
- **[Card Network Role Overview](/ecosystem/fundamentals/card-network-role/)** - Core concepts and network functions
- **[Open-Loop vs Closed-Loop](/ecosystem/fundamentals/card-network-role/open-vs-closed-loop)** - Network models explained
- **[Transaction Routing](/ecosystem/fundamentals/card-network-role/transaction-routing)** - BIN routing and authorization flow
- **[Network Rules](/ecosystem/fundamentals/card-network-role/network-rules)** - Compliance and consequences
- **[Network Fees](/ecosystem/fundamentals/card-network-role/network-fees)** - Assessments and passthrough fees
- **[Card-Present vs CNP](/ecosystem/fundamentals/card-network-role/card-present-vs-cnp)** - Risk and interchange differences

**Foundation:**
- **[Four-Party Model](/ecosystem/fundamentals/four-party-model/)** - Core participants explained
- **[Four-Party Model Quiz](/ecosystem/fundamentals/four-party-model/quiz)** - Test foundational knowledge

---

*Continue learning: [Transaction Lifecycle](/ecosystem/fundamentals/transaction-lifecycle/overview)*
