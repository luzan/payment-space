...
See Four-Party Model <!-- (/ecosystem/core-concepts/four-party-model not yet migrated) --> for detailed fee breakdown diagrams.
...
*Previous Topic: [Payment Gateways](/ecosystem/industry-players/payment-gateways/overview)*

*Next Topic: [ISOs (Independent Sales Organizations)](/ecosystem/industry-players/isos)*
...
| Transaction Lifecycle <!-- (/ecosystem/core-concepts/transaction-lifecycle not yet migrated) --> | Settlement, funding, and chargebacks |
| Debit Networks [Debit Networks & Routing Routing<!-- (/ecosystem/core-concepts/debit-routing not yet migrated) --> | Durbin Amendment and debit interchange |
| [Payment Processors](/ecosystem/industry-players/payment-processors) | Processor vs acquirer distinction |
| [Payment Gateways](/ecosystem/industry-players/payment-gateways/overview) | Gateway integration with acquirers |
| [ISOs](/ecosystem/industry-players/isos) | ISO-acquirer relationships |
| [ISVs](/ecosystem/industry-players/isvs) | PayFac model and sponsor bank requirements |
