...
*Previous Topic: [Payment Processors](/ecosystem/industry-players/payment-processors)*

*Next Topic: [Acquiring Banks](/ecosystem/industry-players/acquiring-banks/overview)*
...
| [Card Network Role](/ecosystem/fundamentals/card-network-role) | Network assessments and CP/CNP distinction |
| Transaction Lifecycle | Authorization, settlement, and chargebacks |
| Debit Networks & Routing | PINless routing through gateway |
| [Payment Processors](/ecosystem/industry-players/payment-processors) | Gateway vs processor distinction |
| [Acquiring Banks](/ecosystem/industry-players/acquiring-banks/overview) | Settlement and sponsor bank relationships |
| [ISOs](/ecosystem/industry-players/isos) | White-label gateway distribution |
