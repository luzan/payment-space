...
- [Four-Party Model](/ecosystem/fundamentals/four-party-model) - Foundation for understanding payment flows
- [Payment Gateways](/ecosystem/industry-players/payment-gateways/overview) - Technical integration layer
- [Acquiring Banks](/ecosystem/industry-players/acquiring-banks/overview) - Traditional acquiring model details
- [ISOs](/ecosystem/industry-players/isos) - Independent Sales Organizations deep dive
- [ISVs](/ecosystem/industry-players/isvs) - Independent Software Vendors in payments
- [PayFac Overview](/ecosystem/payfac-model/overview) - Payment Facilitator deep dive
- [PayFac Implementation](/ecosystem/payfac-model/implementation) - Building a PayFac platform
