...
Independent Sales Organizations (ISOs) are the sales force of the payment industry. They act as intermediaries between merchants and acquiring banks/payment processors, handling merchant acquisition, onboarding, and ongoing support. Understanding ISOs is essential for PayFac platforms because ISOs often become reseller partners or competitors.
...
See [Four-Party Model](./01-four-party-model.md) for more on the foundational payment structure and [Payment Processors](./05-payment-processors.md) for processor roles.
...
See [Four-Party Model](./01-four-party-model.md) for the foundational payment structure that ISOs operate within.
...
*Previous Topic: [Acquiring Banks](./07-acquiring-banks.md)*

*Next Topic: [ISVs (Independent Software Vendors)](./09-isvs.md)*
...
| Topic | Description |
|-------|-------------|
| [The Four-Party Model](./01-four-party-model.md) | Payment ecosystem where ISOs operate |
| [Card Network Role](./02-card-network-role.md) | Network registration requirements for ISOs |
| [Transaction Lifecycle](./03-transaction-lifecycle.md) | Authorization and settlement that ISOs don't control |
| [Payment Processors](./05-payment-processors.md) | Processors that ISOs partner with |
| [Payment Gateways](./06-payment-gateways.md) | Gateway solutions ISOs resell |
| [Acquiring Banks](./07-acquiring-banks.md) | Sponsor banks for ISO registration |
| [ISVs](./09-isvs.md) | PayFac model that competes with ISOs |
